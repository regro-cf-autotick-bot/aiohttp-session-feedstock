...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiohttp-session-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6944&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiohttp-session-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiohttp-session` can be installed with:

```
conda install aiohttp-session
```

It is possible to list all of the versions of `aiohttp-session` available on your platform with:
